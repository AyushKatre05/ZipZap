...
import { ArrowLeft, Home, Menu, Search, ShoppingBag, ShoppingCart, User } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <div className="cursor-pointer" onClick={() => router.push("/listing")}>
              <Search/>
            </div>
